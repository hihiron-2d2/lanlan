...
import 'package:lanlan/card/card_delete_page.dart';
import 'package:lanlan/card/card_edit_page.dart';
        ...
        body: SingleChildScrollView(
          child: Center(
            child: Consumer<CardListModel>(builder: (context, model, child,) {
              final List<Flipcard>? flipcard = model.flipcard;
                          ...
                          SlidableAction(
                            onPressed: (context) async {
                              ...
                              final String? frontWord = await Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => DeleteCardPage(flipcard, id: id),
                                ),
                              );
