...
import 'package:lanlan/card/card_edit_model.dart';
import 'package:lanlan/domain/card.dart';
import 'package:provider/provider.dart';

// ignore: must_be_immutable
class DeleteCardPage extends StatelessWidget {
  String? id;
  final Flipcard flipcard;
  DeleteCardPage(this.flipcard, {Key? key, required this.id}) : super(key: key);
